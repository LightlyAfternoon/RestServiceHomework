...
//        ExamEntity exam = new ExamEntity(1, new Date(new GregorianCalendar(2011,Calendar.SEPTEMBER,1).getTimeInMillis()), group, subject, teacher);
//        Mockito.when(mockSubjectService.findById(1)).thenReturn(subjectMapper.mapToDTO(subjectEntity));
//        Mockito.when(mockSubjectService.findAllExamsWithSubjectId(1)).thenReturn(List.of(examDTOMapper.mapToDTO(exam)));
...
//                new Date(new GregorianCalendar(2016,Calendar.JANUARY,5).getTimeInMillis()), teacherMapper.mapToDTO(teacher));
//        Mockito.when(mockSubjectService.findById(1)).thenReturn(subjectMapper.mapToDTO(subjectEntity));
